  ...
  const handleSaveSpace = async () => {
    ...
    try {
      ...
      if (draftSpace.dirMode === "panorama") {
        ...
        setCreatedSpaces((prev) => isEditing ? prev.map((s) => s.id === editingSpaceId ? savedSpace : s) : [...prev, savedSpace]);
      } else {
              ...
              <>
                ...
                {draftSpace.panoramaUri ? (
                  ...
                  >
                    ...
                    {/* Drag layer — handles pin dragging */}
                    <View
          ...
          {showPinModal && (
            <View style={[StyleSheet.absoluteFill, { backgroundColor: colors.background, zIndex: 50 }]}>
              ...
              <ScrollView contentContainerStyle={styles.modalScroll} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
                ...
                {/* ── Mini panorama with pin position ── */}
...
const styles = StyleSheet.create({
  ...
  // Pano upload slot (normal / ready state) — 180px tall
  ...
  // Pano placement mode — taller for easier pin placement
  panoPlaceSlot: { width: "100%", height: 240, borderRadius: 16, borderWidth: 2, overflow: "hidden", marginTop: 4 },

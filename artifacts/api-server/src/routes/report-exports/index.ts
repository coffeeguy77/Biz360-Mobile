  ...
  if (rawToken) {
    try {
      ...
      if (secret) {
        ...
        // Only buyer-report-access tokens unlock approved-buyer PDF content.
        // seller-preview tokens are intentionally excluded — they are for sellers
        // viewing their own report, not for accessing buyer-gated PDF sections
        // on behalf of a buyer identity.
        if (
          payload.type === "buyer-report-access" &&
